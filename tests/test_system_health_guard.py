...
MODULE_PATH = ROOT / "jobhub" / "system_health_guard.py"
SPEC = importlib.util.spec_from_file_location("jobhub_system_health_guard_test", MODULE_PATH)
...
class SystemHealthGuardTests(unittest.TestCase):
    ...
    def test_guard_is_installed_before_mobile_navigation(self):
        ...
        self.assertIn("from .system_health_guard import install_system_health_guard", source)
    ...
    def test_health_summary_prioritises_critical_then_warning(self):
        ...
        original_backup = MODULE._backup_report
        ...
        try:
            ...
            MODULE._backup_report = lambda: ([MODULE._check("Recovery", "Backup", "Critical", "old")], {})
            ...
            MODULE._backup_report = original_backup
